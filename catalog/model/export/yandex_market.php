...
class ModelExportYandexMarket extends Model {
	...
	public function getProductDiscounts($product_id) {
		$query = $this->db->query("SELECT price FROM " . DB_PREFIX . "product_discount WHERE product_id = '" . (int)$product_id . "' AND customer_group_id = '4'ORDER BY price ASC");
		return $query->rows;
	}
