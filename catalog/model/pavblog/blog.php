...
class ModelPavblogBlog extends Model {		
	...
	public function getInfo( $id ){
		...
		$query = ' SELECT b.*,bd.title,bd.description,cd.title as category_title,bd.content,bd.item_link,bd.item_button_text,bd.blog_products  FROM '
		...
		# BEGIN JNX
		$sql_images = "SELECT * FROM ".DB_PREFIX."pavblog_images WHERE news_id=".(int)$id . " ORDER BY `original_name`, `id` DESC";
		$query_images = $this->db->query( $sql_images );
		$blog['images'] = $query_images->rows;
