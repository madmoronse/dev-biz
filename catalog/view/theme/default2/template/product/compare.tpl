<?php echo $header; ?>
<?php if ($success) { ?>
<div class="success"><?php echo $success; ?><img src="catalog/view/theme/default2/image/close.png" alt="" class="close" /></div>
<?php } ?>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php if ($products[$product['product_id']]['thumb']) { ?>
          <a href="<?php echo $products[$product['product_id']]['popup']; ?>" title="<?php echo $products[$product['product_id']]['name']; ?>" class="colorbox"><img src="<?php echo $products[$product['product_id']]['thumb']; ?>" alt="<?php echo $products[$product['product_id']]['name']; ?>" /></a>
          <?php } ?></td>
        <?php } ?>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><?php echo $products[$product['product_id']]['product_id']; ?></td>
        <?php } ?>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/default2/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
