 ...
 */
class ControllerFeedYmlNoAttributes extends Controller {
	private $shop = array();
	...
	public function index() {
		if ($this->config->get('yandex_market_status')) {
			...
			$filename = str_replace('/catalog/', '', DIR_APPLICATION) . '/price/drop_hhufhfw9f874h2f427894fh7.yml';
