<?php
class ControllerCheckoutfPaymentMethod extends Controller {
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkoutf/payment_method.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkoutf/payment_method.tpl';
		} else {
			$this->template = 'default/template/checkoutf/payment_method.tpl';
		}
