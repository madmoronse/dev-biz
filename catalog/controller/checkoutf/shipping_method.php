<?php
class ControllerCheckoutfShippingMethod extends Controller {
  	public function index()
	{
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkoutf/shipping_method.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkoutf/shipping_method.tpl';
		} else {
			$this->template = 'default/template/checkoutf/shipping_method.tpl';
		}
