<?php
class ControllerCheckoutfGuestShipping extends Controller {
  	public function index() {
		...
		if (isset($this->session->data['guest']['shipping']['address_3'])) {
			$this->data['address_3'] = $this->session->data['guest']['shipping']['address_3'];
		} else {
			$this->data['address_3'] = '';
		}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkoutf/guest_shipping.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkoutf/guest_shipping.tpl';
		} else {
			$this->template = 'default/template/checkoutf/guest_shipping.tpl';
		}
