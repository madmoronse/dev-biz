	...
	public function index() { 
		...
		$this->data['button_continue'] = $this->language->get('button_continue');
			...
			$this->data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/showproductall', '&sort=p.date_added&order=ASC' . $url)
			);

			$this->data['sorts'][] = array(
				'text'  => $this->language->get('text_moddate_desc'),
				'value' => 'p.date_added-DESC',
				'href'  => $this->url->link('product/showproductall', '&sort=p.date_added&order=DESC' . $url)
			);
