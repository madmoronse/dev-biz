	...
	private $error = array();
  	...
  	public function index() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			unset($this->session->data['amo_utm']);
			...
			if ($this->config->get('config_tax_customer') == 'shipping') {
				...
				$this->session->data['shipping_naselenniy_punkt_id'] = '2';
			}
			...
			if ($this->config->get('config_tax_customer') == 'payment') {
				...
				$this->session->data['payment_naselenniy_punkt_id'] = '2';				
			}
		...
		$this->data['text_first_contact_method'] = $this->language->get('text_first_contact_method');
    	...
    	$this->data['entry_teacher'] = $this->language->get('entry_teacher');
        ...
        if (isset($this->error['first_contact_method'])) {
            $this->data['error_first_contact_method'] = $this->error['first_contact_method'];
        } else {
            $this->data['error_first_contact_method'] = '';
        }
		...
		if (isset($this->request->post['address_1'])) {
			...
			//if ($this->data['address_1'] = 'Нет улицы') $this->data['address_1'] = '';
		} else {
			$this->data['address_1'] = '';
		}
		...
		if (isset($this->request->post['address_3'])) {
			...
			//if ($this->data['address_3'] = 'Частный дом') $this->data['address_3'] = '';
		} else {
			$this->data['address_3'] = '';
		}
		...
		if (isset($this->request->post['naselenniy_punkt_id'])) {
      		$this->data['naselenniy_punkt_id'] = $this->request->post['naselenniy_punkt_id'];
		} elseif (isset($this->session->data['shipping_naselenniy_punkt_id'])) {
			$this->data['naselenniy_punkt_id'] = $this->session->data['shipping_naselenniy_punkt_id'];		
		} else {	
      		$this->data['naselenniy_punkt_id'] = '2';
    	}
    	...
    	if (isset($this->request->post['zone_id'])) {
			...
			$this->data['zone_id'] = $this->session->data['shipping_zone_id'];			
      		...
      		//$this->data['zone_id'] = '';
			$this->data['zone_id'] = $this->registry->get('geoip')->getZoneId();
    	}
		...
		$results = $this->model_account_teacher->getTeachers();
        foreach ($results as $result) {

            $data = $this->model_account_teacher->getTeacherInfo($result['customer_id']);
		...
		if (isset($this->request->post['first_contact_method'])) {
    		$this->data['first_contact_method'] = $this->request->post['first_contact_method'];
		} else {
			$this->data['first_contact_method'] = '';
		}
  	...
  	protected function validate() {
    	...
    	if ($this->request->post['type'] !== 'opt' && (utf8_strlen($this->request->post['qiwi']) < 10) || (utf8_strlen($this->request->post['qiwi']) > 32)) {
		...
		//$naselenniy_punkt_info = $this->model_localisation_country->getNaselenniyPunkt($this->request->post['naselenniy_punkt_id']);
    	...
    	if (!isset($this->request->post['first_contact_method']) || $this->request->post['first_contact_method'] == '') {
      		$this->error['first_contact_method'] = $this->language->get('error_first_contact_method');
    	}
