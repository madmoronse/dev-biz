	...
	private $error = array();
  	...
  	protected function getList() {
    	...
    	foreach ($results as $result) {
			...
			$replace = array(
				...
				'naselenniy_punkt' => $result['naselenniy_punkt'],
      			'city'      => $result['city'],
  	...
  	protected function getForm() {
		...
		if (isset($this->request->post['middlename'])) {
			...
			$this->data['middlename'] = $address_info['middlename'];
		} else {
    	...
    	if (isset($this->request->post['address_3'])) {
			...
			$this->data['address_3'] = $address_info['address_3'];
		} else {
      		$this->data['address_3'] = '';
    	}
		...
		if (isset($this->request->post['address_4'])) {
			...
			$this->data['address_4'] = $address_info['address_4'];
		} else {
      		$this->data['address_4'] = '';
    	}
		...
		if (isset($this->request->post['social'])) {
			...
			$this->data['social'] = $address_info['social'];
		} else {
      		$this->data['social'] = '';
    	}
		...
		if (isset($this->request->post['naselenniy_punkt_id'])) {
			...
			$this->data['naselenniy_punkt_id'] = $address_info['naselenniy_punkt_id'];
		} else {
