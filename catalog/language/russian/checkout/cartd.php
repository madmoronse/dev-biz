...
// Text
//$_['text_success']           = '<img src="%s" alt="%s" title="%s" /><a href="%s">%s</a> добавлен в <a href="%s">корзину покупок</a>!';
$_['text_success']           = '<a href="%s">%s</a> добавлен в <a href="%s" style="color:#e90000;">корзину покупок</a>!';
...
$_['column_drop_name']       = 'Наименование';
$_['column_model']           = 'Модель';
$_['column_sku']             = 'Артикул';
$_['column_drop_sku']        = 'Арт';
$_['column_quantity']        = '<span title="Количество">Кол-во</span>';
$_['column_drop_quantity']   = 'Количество';
$_['column_price']           = 'Цена';
$_['column_drop_price']      = 'Цена за шт.';
$_['column_total']           = 'Сумма';
$_['column_drop_total']      = 'Сумма';
$_['column_drop_profit']     = 'Прибыль';
$_['column_drop_sell']       = 'Цена продажи';
$_['column_drop_charge']     = 'Наценка';
...
$_['error_no_more_gifts']    = 'Вам недоступно добавление подарков!';
$_['error_sell_price']       = 'Цена продажи должна быть больше вашей цены';
?>