...
\Neos\debug\Debug::$allow_debug = false;
\Neos\debug\Debug::$allow_timing = false;
...
//roi_chain
//require_once('./crontab/roi_chain_v5.php');
...
function error_handler($errno, $errstr, $errfile, $errline) {
    ...
    if ($errno === $error_reporting || E_ALL === $error_reporting) {
...
//$controller->addPreAction(new Action('common/utm'));
