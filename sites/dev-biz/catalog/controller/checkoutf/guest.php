<?php
class ControllerCheckoutfGuest extends Controller {
  	public function index() {
		...
		if (isset($this->session->data['guest']['payment']['address_3'])) {
			$this->data['address_3'] = $this->session->data['guest']['payment']['address_3'];
		} else {
			$this->data['address_3'] = '';
		}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkoutf/guest.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkoutf/guest.tpl';
		} else {
			$this->template = 'default/template/checkoutf/guest.tpl';
		}
	...
	public function validate() {
		...
		if (!$json) {
			...
			$this->session->data['guest']['payment']['middlename'] = $this->request->post['middlename'];
			...
			$this->session->data['guest']['payment']['address_3'] = $this->request->post['address_3'];
			...
			if ($this->session->data['guest']['shipping_address']) {
				...
				$this->session->data['guest']['shipping']['middlename'] = $this->request->post['middlename'];
				...
				$this->session->data['guest']['shipping']['address_3'] = $this->request->post['address_3'];
