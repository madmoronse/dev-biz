<?php
class ControllerCheckoutfLogin extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkoutf/login.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkoutf/login.tpl';
		} else {
			$this->template = 'default/template/checkoutf/login.tpl';
		}
