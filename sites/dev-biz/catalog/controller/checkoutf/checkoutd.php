<?php
class ControllerCheckoutfCheckoutd extends Controller {
    public function index() {
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('checkoutf/checkoutd', '', 'SSL'),
            'separator' => $this->language->get('text_separator')
        );
        ...
        } else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkoutf/checkoutd.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/checkoutf/checkoutd.tpl';
        } else {
            $this->template = 'default/template/checkoutf/checkoutd.tpl';
        }
