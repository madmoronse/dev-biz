	...
	protected function str_split_unicode($str, $l = 0) {
  	...
  	public function index() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validate()) {
			...
			$this->data['data']['image1'] = strip_tags(html_entity_decode($this->request->post['image1']));
			$this->data['data']['image2'] = strip_tags(html_entity_decode($this->request->post['image2']));
			$this->data['data']['image3'] = strip_tags(html_entity_decode($this->request->post['image3']));
