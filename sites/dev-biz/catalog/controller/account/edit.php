...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
        ...
        $this->data['teachers'] = $this->model_account_teacher->getTeacher($this->data['teacher']);
        $this->data['teacher_name'] = $this->data['teachers']['name'];
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['qiwi']) < 10) || (utf8_strlen($this->request->post['qiwi']) > 32)) {
