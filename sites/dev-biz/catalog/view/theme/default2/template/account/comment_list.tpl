...
<div id="content"><?php echo $content_top; ?>
  ...
  <h2 class="h2-head"> <?php echo $text_comment_list; ?> </h2>
  <?php foreach ($comments as $result) { ?>
  <div class="content">
    <table class="my-address">
      <tr>
        <td>
  ...
  <div class="buttons">
    ...
    <div class="right"><a href="<?php echo $insert; ?>" class="button"><?php echo $button_new_comment; ?></a></div>
  </div>
