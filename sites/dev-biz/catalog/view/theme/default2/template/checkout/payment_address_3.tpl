    ...
    */?>
      ...
      <div class="payment-information">
        ...
        $(document).ready(function() {
              ...
              .add(
                ...
                function () {
                  ...
                  //console.log(ymaps.geocode(coords.bounds[0]));
                    ...
                    "type":"POST",
                    "data": {"query": myPlacemark.geometry._coordinates, "context":"payment_address_3"}
                    });
					// Neos DEBUG -- END
          ...
          $("#zone, #area, #city, #address_1, #address_2").on("change", function() {
            drawResult();
          })
      ...
      <div class="payment-form__item fullsize">
        <label for="postcode"><?php echo $entry_comments; ?></label>
        <textarea name="comments" id="comments"><?= ($addresses) ? $addr['postcode'] :""?></textarea>
