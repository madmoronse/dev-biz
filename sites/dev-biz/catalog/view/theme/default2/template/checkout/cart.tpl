...
<div id="content" class="cart-page"><?php echo $content_top; ?>
    ...
    <div class="cart-info">
      <table>
        ...
        <tbody>
          ...
          <tr <?php if (!$product['stock']) { echo "class='OutOfStockTr'"; }?>>
  ...
  <div class="cart-module">
    ...
    <div id="shipping" class="content">
      ...
      <table>
        ...
        <tr>
          <td><span id="city" class="required">*</span> <?php echo $entry_city; ?></td>
          <td><input type="text" name="city" value="<?php echo $city; ?>" /></td>
        </tr>

        <tr>
          <td><span id="address_1" class="required">*</span> <?php echo $entry_address; ?></td>
  ...
  <div class="buttons">
    <? //if($_SERVER["REMOTE_ADDR"]=='188.0.30.39'): ?>
      ...
      <? else: ?>
        <div class="right"><a href="<?php echo $checkout; ?>" <?php if ($customerIsNotLoggedIn) { echo 'onclick="event.preventDefault(); $(\'#login-modal\').click();"';} ?> class="button"><?php echo $button_checkout; ?></a></div>
      <? endif; ?>
    <? /*else: ?>
...
$('#button-quote').live('click', function() {
	$.ajax({
		...
		type: 'post',
		data: 'country_id=' + $('select[name=\'country_id\']').val() + '&zone_id=' + $('select[name=\'zone_id\']').val() + '&city=' + $('input[name=\'city\']').val() + '&address_1=' + $('input[name=\'address_1\']').val() + '&postcode=' + encodeURIComponent($('input[name=\'postcode\']').val()),
		dataType: 'json',
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '  <table class="radio calc-delivery">';

				for (i in json['shipping_method']) {
					html += '<tr class="title-calc">';
