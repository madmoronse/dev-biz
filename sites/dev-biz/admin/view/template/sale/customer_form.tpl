    ...
    <div class="content">
      ...
      <tr>
              ...
              <tr>
                ...
                <td><input type="text" id="qiwi" name="qiwi" value="<?php echo $qiwi; ?>" />
                  <input type="checkbox" name="non_qiwi" id="non_qiwi" <?php echo $non_qiwi; ?>>
                  <label for="non_qiwi">Нет кошелька</label>
                  <?php if ($error_qiwi) { ?>
              ...
              <tr>
                ...
                <?php if (isset($managers)) { ?>
                  ...
                  <option value="NULL">Не задан</option>
                    <?php foreach ($managers as $currentManager) { ?>
                    <?php if ($manager == $currentManager) { ?>
                    <option value="<?php echo $currentManager ?>" selected="selected"><?php echo $currentManager; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $currentManager; ?>"><?php echo $currentManager; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select></td>                    
                <?php } else { ?>
                  <td><input type="text" name="manager" value="<?php echo $manager; ?>" readonly/></td>
                <?php } ?>
              </tr>
              ...
              <tr>
                ...
                <td><select name="teacher">
                    ...
                    <?php foreach ($teachers as $result) { ?>
                    <?php if ($result['teacher_id'] == $teacher) { ?>
                    <option value="<?php echo $result['teacher_id']; ?>" selected="selected"><?php echo $result['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $result['teacher_id']; ?>"><?php echo $result['name']; ?></option>
                    <?php }?>
                    <?php }?>
                  </select>
                </td>
      ...
      <tr>
        ...
        <tr>
        <td><span class="required">*</span> <?php echo $entry_middlename; ?></td>
        <td><input type="text" name="address[<?php echo $address_row; ?>][middlename]" value="<?php echo $address['middlename']; ?>" />
        <?php if (isset($error_address_middlename[$address_row])) { ?>
        <span class="error"><?php echo $error_address_middlename[$address_row]; ?></span>
        <?php } ?></td>
      </tr>
              ...
              <tr class="company-id-display" style="display:none;">
        ...
        <tr>
                    ...
                    <td><input type="text" name="address[<?php echo $address_row; ?>][address_4]" value="<?php echo $address['address_4']; ?>" />
                        <?php if (isset($error_address_address_4[$address_row])) { ?>
                            <span class="error"><?php echo $error_address_address_4[$address_row]; ?></span>
                        <?php } ?></td>
                </tr>
        
              <tr>
                <td><span class="required">*</span> <?php echo $entry_address_3; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][address_3]" value="<?php echo $address['address_3']; ?>" />
                  <?php if (isset($error_address_address_3[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_address_3[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
        ...
        <tr>
                    ...
                    <td><input type="text" name="address[<?php echo $address_row; ?>][social]" value="<?php echo $address['social']; ?>" />
                        </td>
                </tr>
...
function addAddress() { 
  ...
  html += '    <tr>';
  html += '      <td><span class="required">*</span> <?php echo $entry_middlename; ?></td>';
  html += '      <td><input type="text" name="address[' + address_row + '][middlename]" value="" /></td>';
  html += '    </tr>';    
    ...
    html += '    </tr>';
    html += '    <tr>';
    html += '      <td><span class="required">*</span> <?php echo $entry_address_3; ?></td>';
    html += '      <td><input type="text" name="address[' + address_row + '][address_3]" value="" /></td>';
    html += '    </tr>';
    html += '    <tr>';
...
//--></script> 
<script type="text/javascript"><!--
    $('#non_qiwi').on('change', function () {
    if ($(this).is(':checked') ) {
      $('#qiwi').prop('disabled',true);
    } else {
      $('#qiwi').prop('disabled',false);
    }
  });

$(document).ready(function(){
   if ($('#non_qiwi').is(':checked') ) {
     $('#qiwi').prop('disabled',true);
   }
});
