      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <table class="form">
            <tr>
              ...
              <td><select name="payment_address">
                  ...
                  <option value="<?php echo $address['address_id']; ?>"><?php echo $address['lastname'] . ', ' . $address['firstname'] . ' ' . $address['middlename'] . ', ' . $address['address_1'] . ', ' . $address['address_2'] . ', ' . $address['address_3'] . ', ' . $address['city'] . ', ' . $address['country']; ?></option>
                  <?php } ?>
                </select></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_middlename; ?></td>
              <td><input type="text" name="payment_middlename" value="<?php echo $payment_middlename; ?>" />
                <?php if ($error_payment_middlename) { ?>
                <span class="error"><?php echo $error_payment_middlename; ?></span>
                <?php } ?></td>
            </tr>
            ...
            <tr>
              ...
              <td><input type="text" name="payment_address_3" value="<?php echo $payment_address_3; ?>" />
                <?php if ($error_payment_address_3) { ?>
                <span class="error"><?php echo $error_payment_address_3; ?></span>
                <?php } ?></td>
            </tr>
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_middlename; ?></td>
              <td><input type="text" name="shipping_middlename" value="<?php echo $shipping_middlename; ?>" />
                <?php if ($error_shipping_middlename) { ?>
                <span class="error"><?php echo $error_shipping_middlename; ?></span>
                <?php } ?></td>
            </tr>
            <tr style="display:none;">
              <td><?php echo $entry_company; ?></td>
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_address_3; ?></td>
              <td><input type="text" name="shipping_address_3" value="<?php echo $shipping_address_3; ?>" />
                <?php if ($error_shipping_address_3) { ?>
                <span class="error"><?php echo $error_shipping_address_3; ?></span>
                <?php } ?></td>
            </tr>
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
                ...
                <td class="left"><?php echo $order_product['name']; ?><br />
                  ...
                  <?php $download_row++; ?>
                  <?php } ?></td>
                <td class="left"><?php echo $order_product['order_product_id']; ?>
                  <input type="hidden" name="order_product[<?php echo $product_row; ?>][order_product_id]" value="<?php echo $order_product['order_product_id']; ?>" /></td>
            ...
            <tbody id="total">
              ...
              <tr>
                <td class="left"><?php echo $order_product['name']; ?><br />
                  ...
                  - <small><?php echo $option['name']; ?>: <?php echo $option['value']; ?></small><br />
                  <?php } ?></td>
                <td class="left"><?php echo $order_product['order_product_id']; ?></td>
...
$('input[name=\'customer\']').catcomplete({
	...
	select: function(event, ui) { 
		...
		$('input[name=\'middlename\']').attr('value', ui.item['middlename']);
		...
		for (i in  ui.item['address']) {
			html += '<option value="' + ui.item['address'][i]['address_id'] + '">' + ui.item['address'][i]['lastname'] + ', ' + ui.item['address'][i]['firstname'] + ' ' + ui.item['address'][i]['middlename'] + ', ' + ui.item['address'][i]['address_1'] + ', ' + ui.item['address'][i]['address_2'] + ', ' + ui.item['address'][i]['address_3'] + ', ' + ui.item['address'][i]['city'] + ', ' + ui.item['address'][i]['country'] + '</option>';
		}
	...
	$.ajax({
		...
		success: function(json) {
			if (json != '') {	
				...
				$('input[name=\'payment_middlename\']').attr('value', json['middlename']);
				...
				$('input[name=\'payment_address_3\']').attr('value', json['address_3']);
	...
	$.ajax({
		...
		success: function(json) {
			if (json != '') {	
				...
				$('input[name=\'shipping_middlename\']').attr('value', json['middlename']);
				...
				$('input[name=\'shipping_address_3\']').attr('value', json['address_3']);
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				if (json['error']['payment']) {	
					...
					if (json['error']['payment']['middlename']) {
						$('input[name=\'payment_middlename\']').after('<span class="error">' + json['error']['payment']['middlename'] + '</span>');
					}	
					...
					if (json['error']['payment']['address_3']) {
						$('input[name=\'payment_address_3\']').after('<span class="error">' + json['error']['payment']['address_3'] + '</span>');
					}	
				...
				if (json['error']['shipping']) {	
					...
					if (json['error']['shipping']['middlename']) {
						$('input[name=\'shipping_middlename\']').after('<span class="error">' + json['error']['shipping']['middlename'] + '</span>');
					}	
					...
					if (json['error']['shipping']['address_2']) {
						$('input[name=\'shipping_address_2\']').after('<span class="error">' + json['error']['shipping']['address_2'] + '</span>');
					}
					
					if (json['error']['shipping']['address_3']) {
						$('input[name=\'shipping_address_3\']').after('<span class="error">' + json['error']['shipping']['address_3'] + '</span>');
					}	
