...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><a href="#tab-additional-products"><?php echo $tab_additional_products; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-design">
          ...
          <div id="tab-additional-products">

              <table class="form">
                  <tr>
                      <td style="display:none"><?php echo $entry_add_products_from_category; ?></td>
                      <td style="display:none"><input type="text" name="add_products_from_category" value="<?php echo $add_products_from_category; ?>" onkeyup="this.value = this.value.replace (/[^0-9,]/, '')" autocomplete="nope" /></td>
                  </tr>
                  <tr>
                      <td style="display:none"><?php echo $entry_substract_products_from_category; ?></td>
                      <td style="display:none"><input type="text" name="substract_products_from_category" value="<?php echo $substract_products_from_category; ?>" onkeyup="this.value = this.value.replace (/[^0-9,]/, '')" autocomplete="nope" /></td>
                  </tr>
                  <tr>
                      <td style="display:none"><?php echo $entry_substract_products; ?></td>
                      <td style="display:none"><input type="text" name="substract_products" value="<?php echo $substract_products; ?>" onkeyup="this.value = this.value.replace (/[^0-9,]/, '')" autocomplete="nope" /></td>
                  </tr>
                  <tr>
                      <td><?php echo $entry_add_products; ?></td>
                      <td><textarea name="add_products" onkeyup="this.value = this.value.replace (/[^0-9\n]/, '')" autocomplete="nope" cols="40" rows="30"><?php echo $add_products; ?></textarea></td>
                  </tr>

                  <tr>
                      <td class="left"><?php echo $entry_menu_button_background_color; ?></td>
                      <td class="left"><input name="menu_button_background_color" value="<?php echo $menu_button_background_color; ?>" onkeyup="this.value = this.value.replace (/[^0-9^a-f^A-F]/, '')"></td>
                  </tr>
                  <tr>
                      <td class="left"><?php echo $entry_menu_button_text_color; ?></td>
                      <td class="left"><input name="menu_button_text_color" value="<?php echo $menu_button_text_color; ?>" onkeyup="this.value = this.value.replace (/[^0-9^a-f^A-F]/, '')"></td>
                  </tr>
                  <tr>
                      <td class="left"><?php echo $entry_category_sticker; ?></td>
                      <td>
                          <div class="image">
                              <img src="<?php echo $category_sticker_thumb; ?>" alt=""  id="thumb_category_sticker"/>
                              <input type="hidden" name="category_sticker_image" value="<?php echo $category_sticker_image; ?>"  id="category_sticker_image"/>
                              <br />
                              <a onclick="image_upload('category_sticker_image', 'thumb_category_sticker');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb_category_sticker').attr('src', '<?php echo $no_image; ?>'); $('#category_sticker_image').attr('value', '');"><?php echo $text_clear; ?></a>
                          </div></td>
                  </tr>
              </table>
          </div>
