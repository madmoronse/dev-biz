    ...
    <div class="content">
        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            ...
            <table class="form">
			  ...
			  <textarea rows="10" style="width: 99%;" name="testimonial_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($testimonial_description[$language['language_id']]) ? $testimonial_description[$language['language_id']]['description'] : ''; ?></textarea>
      ...
      <table class="form">
				...
				<tr>
					...
					<td> <input type="text" name="image1" value="<?php echo $image1; ?>" style="width: 306px;"/></td>
		        </tr>
				<tr>
					<td> <?php echo $entry_image2; ?></td>
					<td> <input type="text" name="image2" value="<?php echo $image2; ?>" style="width: 306px;"/></td>
		        </tr>
				<tr>
					<td> <?php echo $entry_image2; ?></td>
					<td> <input type="text" name="image3" value="<?php echo $image3; ?>" style="width: 306px;"/></td>
		        </tr>
