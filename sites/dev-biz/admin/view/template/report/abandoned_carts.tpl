            ...
            <div class="content">
                <table class="list">
                    ...
                    <tr>
                        ...
                        <td class="left">Товары в корзине</td>
                    ...
                    <tr class="filter">
                        ...
                        <td><select name="filter_customer_group_id">
                            ...
                            <?php if ($customer_group['customer_group_id']  != 4 and   $customer_group['customer_group_id']  != 3) {continue;} ?>
                    ...
                    <?php if ($customers) { ?>
                        <?php foreach ($customers as $customer) { ?>
                            <tr>
                                ...
                                <td class="left">
                                    <?php if ($customer['cart_products']) { ?>
                                        <table style="width:100%;">
                                            <?php foreach($customer['cart_products'] as $product) { ?>
                                                <tr>
