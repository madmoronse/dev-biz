...
$_['entry_cache_on_delivery']	= 'Учитывать ограничение наложенного платежа:<span class="help">Только если выбран способ доставки СДЭК</span>';
$_['entry_min_total']		= 'Минимальная сумма заказа:<span class="help">Ниже этого значения оплата не выводится. Оставить поле пустым, чтобы не учитывать</span>';
$_['entry_max_total']		= 'Максимальная сумма заказа:<span class="help">Выше этого значения оплата не выводится. Оставить поле пустым, чтобы не учитывать</span>';
