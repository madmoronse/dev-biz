	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			if (isset($this->request->post['yandex_market_categories'])) {
				$this->request->post['yandex_market_categories'] = implode(',', array_map('intval', $this->request->post['yandex_market_categories']));
			}
			if (isset($this->request->post['yandex_market_sale_categories'])) {
				$this->request->post['yandex_market_sale_categories'] = implode(',', array_map('intval', $this->request->post['yandex_market_sale_categories']));
			}
		...
		/** BY NEOS - Start */
		$this->data['entry_vendor_required'] = $this->language->get('entry_vendor_required');
		$this->data['entry_vendor_required_yes'] = $this->language->get('entry_vendor_required_yes');
		$this->data['entry_vendor_required_no'] = $this->language->get('entry_vendor_required_no');
		$this->data['entry_show_description'] = $this->language->get('entry_show_description');
		$this->data['entry_show_description_yes'] = $this->language->get('entry_show_description_yes');
		$this->data['entry_show_description_no'] = $this->language->get('entry_show_description_no');
		$this->data['entry_file_list'] = $this->language->get('entry_file_list');
		$this->data['entry_file_timeout'] = $this->language->get('entry_file_timeout');
		$this->data['entry_show_outlets'] = $this->language->get('entry_show_outlets');
		$this->data['entry_show_outlets_yes'] = $this->language->get('entry_show_outlets_yes');
		$this->data['entry_show_outlets_no'] = $this->language->get('entry_show_outlets_no');
		$this->data['entry_sale_categories'] = $this->language->get('entry_sale_categories');
		/** BY NEOS - End */
		...
		$this->data['data_feed'] = HTTP_CATALOG . 'index.php?route=feed/yandex_market_by_neos';
		...
		/** BY NEOS - Start */
		if (isset($this->request->post['yandex_market_vendor_required'])) {
			$this->data['yandex_market_vendor_required'] = $this->request->post['yandex_market_vendor_required'];
		} else {
			$this->data['yandex_market_vendor_required'] = $this->config->get('yandex_market_vendor_required');
		}
		if (isset($this->request->post['yandex_market_file_list'])) {
			$this->data['yandex_market_file_list'] = $this->request->post['yandex_market_file_list'];
		} else {
			$this->data['yandex_market_file_list'] = $this->config->get('yandex_market_file_list');
		}
		if (isset($this->request->post['yandex_market_file_timeout'])) {
			$this->data['yandex_market_file_timeout'] = $this->request->post['yandex_market_file_timeout'];
		} else {
			$this->data['yandex_market_file_timeout'] = $this->config->get('yandex_market_file_timeout');
		}
		if (isset($this->request->post['yandex_market_show_outlets'])) {
			$this->data['yandex_market_show_outlets'] = $this->request->post['yandex_market_show_outlets'];
		} else {
			$this->data['yandex_market_show_outlets'] = $this->config->get('yandex_market_show_outlets');
		}
		/** BY NEOS - End */
		...
		if (isset($this->request->post['yandex_market_sale_categories'])) {
			$this->data['yandex_market_sale_categories'] = $this->request->post['yandex_market_sale_categories'];
		} elseif ($this->config->get('yandex_market_sale_categories') != '') {
			$this->data['yandex_market_sale_categories'] = explode(',', $this->config->get('yandex_market_sale_categories'));
		} else {
			$this->data['yandex_market_sale_categories'] = array();
		}
