...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_slim_banner'] = $this->language->get('text_slim_banner');
		$this->data['text_promo_settings'] = $this->language->get('text_promo_settings');
		...
		$this->data['text_teacher'] = $this->language->get('text_teacher');
		...
		$this->data['report_abandoned_carts'] = $this->url->link('report/abandoned_carts', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->data['text_report_sale_return'] = $this->language->get('text_report_sale_return');
		$this->data['text_report_product_viewed'] = $this->language->get('text_report_product_viewed');
		$this->data['text_report_abandoned_carts'] = $this->language->get('text_report_abandoned_carts');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['clear_cache'] = $this->url->link('tool/clear_cache', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['banner'] = $this->url->link('design/banner', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['slim_banner'] = $this->url->link('design/slim_banner', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['promo_settings'] = $this->url->link('catalog/promo_settings', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['teacher'] = $this->url->link('sale/teacher', 'token=' . $this->session->data['token'], 'SSL');
