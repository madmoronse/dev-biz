...
class ControllerShippingEms extends Controller { 
	...
	public function index() {  
		...
		if (isset($this->request->post['ems_cost'])) {
			$this->data['ems_cost'] = $this->request->post['ems_cost'];
		} else {
			$this->data['ems_cost'] = $this->config->get('ems_cost');
		}
		...
		if (isset($this->request->post['ems_geo_zone_id'])) {
			$this->data['ems_geo_zone_id'] = $this->request->post['ems_geo_zone_id'];
		} else {
			$this->data['ems_geo_zone_id'] = $this->config->get('ems_geo_zone_id');
		}
