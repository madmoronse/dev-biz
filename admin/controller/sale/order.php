...
class ControllerSaleOrder extends Controller {
	...
	public function trackingnumber() {
	  ...
	  if (utf8_strlen($this->request->post['tracking_number']) == 14) {
	  
        $this->db->query("UPDATE " . DB_PREFIX . "order SET tracking_number = '" . $this->db->escape($this->request->post['tracking_number']) . "' WHERE order_id = '" . $this->request->get['order_id'] . "'");
		$json['success'] = 'Трек-код ' . $this->request->post['tracking_number'] . ' сохранен и отправлен по заказу ' . $this->request->get['order_id'];
		$json['tracking_number'] =$this->request->post['tracking_number'];
		$this->response->setOutput(json_encode($json)); 
		}          
		else{         
        $json['error'] = 'Почтовый идентификатор должен быть 14 символов!';
		$this->response->setOutput(json_encode($json));
		} 
	...
	$this->load->model('sale/customer_group');
    	...
    	foreach ($results as $result) {
			...
			$this->data['orders'][] = array(
				...
				'shipping_cost' => $result['shipping_costs'],
		...
		$this->data['sort_tracking_number'] = $this->url->link('sale/order', 'token=' . $this->session->data['token'] . '&sort=o.tracking_number' . $url, 'SSL');
		...
		$this->data['filter_tracking_number'] = $filter_tracking_number;
  	...
  	public function getForm() {
		...
		$this->data['column_articul'] = $this->language->get('column_articul');
		...
		$this->data['tab_total'] = $this->language->get('tab_total');
 		...
 		if (isset($this->error['payment_middlename'])) {
			$this->data['error_payment_middlename'] = $this->error['payment_middlename'];
		} else {
			$this->data['error_payment_middlename'] = '';
		}		
		...
		if (isset($this->error['payment_address_3'])) {
			$this->data['error_payment_address_3'] = $this->error['payment_address_3'];
		} else {
			$this->data['error_payment_address_3'] = '';
		}
		...
		if (isset($this->error['shipping_middlename'])) {
			$this->data['error_shipping_middlename'] = $this->error['shipping_middlename'];
		} else {
			$this->data['error_shipping_middlename'] = '';
		}
		...
		if (isset($this->error['shipping_address_3'])) {
			$this->data['error_shipping_address_3'] = $this->error['shipping_address_3'];
		} else {
			$this->data['error_shipping_address_3'] = '';
		}
				
		if (isset($this->error['shipping_address_4'])) {
			$this->data['error_shipping_address_4'] = $this->error['shipping_address_4'];
		} else {
			$this->data['error_shipping_address_4'] = '';
		}
		...
		if (isset($this->request->post['affiliate'])) {
			...
			$this->data['affiliate'] = ($order_info['affiliate_id'] ? $order_info['affiliate_lastname'] . ' ' . $order_info['affiliate_firstname'] . ' ' . $order_info['affiliate_middlename'] : '');
		} else {
      		$this->data['affiliate'] = '';
    	}
		...
		if (isset($this->request->post['payment_middlename'])) {
      		$this->data['payment_middlename'] = $this->request->post['payment_middlename'];
		} elseif (!empty($order_info)) { 
			$this->data['payment_middlename'] = $order_info['payment_middlename'];
		} else {
      		$this->data['payment_middlename'] = '';
    	}
    	...
    	if (isset($this->request->post['payment_address_3'])) {
      		$this->data['payment_address_3'] = $this->request->post['payment_address_3'];
    	} elseif (!empty($order_info)) { 
			$this->data['payment_address_3'] = $order_info['payment_address_3'];
		} else {
      		$this->data['payment_address_3'] = '';
    	}
		...
		if (isset($this->request->post['shipping_middlename'])) {
      		$this->data['shipping_middlename'] = $this->request->post['shipping_middlename'];
		} elseif (!empty($order_info)) { 
			$this->data['shipping_middlename'] = $order_info['shipping_middlename'];
		} else {
    	...
    	if (isset($this->request->post['shipping_address_3'])) {
      		$this->data['shipping_address_3'] = $this->request->post['shipping_address_3'];
    	} elseif (!empty($order_info)) { 
			$this->data['shipping_address_3'] = $order_info['shipping_address_3'];
		} else {
      		$this->data['shipping_address_3'] = '';
    	}
		
    	if (isset($this->request->post['shipping_address_4'])) {
      		$this->data['shipping_address_4'] = $this->request->post['shipping_address_4'];
    	} elseif (!empty($order_info)) { 
			$this->data['shipping_address_4'] = $order_info['shipping_address_4'];
		} else {
  	...
  	protected function validateForm() {
    	...
    	if ((utf8_strlen($this->request->post['payment_middlename']) < 1) || (utf8_strlen($this->request->post['payment_middlename']) > 32)) {
      		$this->error['payment_middlename'] = $this->language->get('error_middlename');
    	}		
    	...
    	if ((utf8_strlen($this->request->post['payment_address_2']) < 1) || (utf8_strlen($this->request->post['payment_address_2']) > 128)) {
      		$this->error['payment_address_2'] = $this->language->get('error_address_2');
    	}

    	if ((utf8_strlen($this->request->post['payment_address_3']) < 1) || (utf8_strlen($this->request->post['payment_address_3']) > 128)) {
      		$this->error['payment_address_3'] = $this->language->get('error_address_3');
    	}
		...
		if ($shipping) {
			...
			if ((utf8_strlen($this->request->post['shipping_middlename']) < 1) || (utf8_strlen($this->request->post['shipping_middlename']) > 32)) {
				$this->error['shipping_middlename'] = $this->language->get('error_middlename');
			}
			...
			if ((utf8_strlen($this->request->post['shipping_address_3']) < 1) || (utf8_strlen($this->request->post['shipping_address_3']) > 128)) {
				$this->error['shipping_address_3'] = $this->language->get('error_address_3');
			}
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->data['button_tracking_number'] = $this->language->get('button_tracking_number');
			...
			$this->data['text_address_3'] = $this->language->get('text_address_2');
			...
			$this->data['tab_total_info'] = $this->language->get('tab_total_info');
			$this->data['tab_order'] = $this->language->get('tab_order');
			$this->data['tab_payment'] = $this->language->get('tab_payment');
			$this->data['tab_shipping'] = $this->language->get('tab_shipping');
			$this->data['tab_product'] = $this->language->get('tab_product');
			...
			$this->data['email'] = $order_info['email'];
			$this->data['telephone'] = $order_info['telephone'];
			$this->data['tracking_number'] = $order_info['tracking_number'];
			$this->data['fax'] = $order_info['fax'];
			...
			$this->data['affiliate_middlename'] = $order_info['affiliate_middlename'];
	...
	public function comments() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if (!$this->data['error']) { 
				$this->model_sale_order->addOrderComments($this->request->get['order_id'], $this->request->post);
				
				$this->data['success'] = 'Комментарий добавлен!';
			}
		}
		...
		$results = $this->model_sale_order->getOrderComments($this->request->get['order_id'], ($page - 1) * 10, 10);
		...
		$comments_total = $this->model_sale_order->getTotalOrderComments($this->request->get['order_id']);
		...
		$pagination->limit = 10; 
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('sale/order/comments', 'token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'] . '&page={page}', 'SSL');
			
		$this->data['pagination'] = $pagination->render();
		
		$this->template = 'sale/order_comments.tpl';		
