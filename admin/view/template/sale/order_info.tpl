...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div class="vtabs"><a href="#tab-history"><?php echo $tab_history; ?></a><a href="#tab-order"><?php echo $tab_order; ?></a><a href="#tab-payment"><?php echo $tab_payment; ?></a>
	  ...
	  <div style="overflow: hidden;">
		...
		<table class="form">
          ...
          <tr>
            ...
            <td><a href="<?php echo $customer; ?>"><?php echo $lastname; ?> <?php echo $firstname; ?> <?php echo $middlename; ?></a></td>
          </tr>
          <?php } else { ?>
          <tr>
            <td><?php echo $text_customer; ?></td>
            <td><?php echo $lastname; ?> <?php echo $firstname; ?> <?php echo $middlename; ?></td>
          </tr>
          <?php } ?>
		  <tr>
          ...
          <?php if ($fax) { ?>
          <tr>
            <td>Получатель - <?php echo $text_fax; ?></td>
            <td><a href="<?php echo $fax; ?>"><?php echo $fax; ?></a></td>
          </tr>
          <?php } ?>		  
		  <?php if ($order_status) { ?>
          <tr>
          ...
          <?php } ?>
		  <tr>
            <td><?php echo $text_recipient; ?></td>
            <td><?php echo $shipping_lastname . " " . $shipping_firstname . " " . $shipping_middlename; ?></td>
          </tr>
          ...
          <?php } ?>
		  <tr>
            <td><?php echo "Адрес:"; ?></td>
            <td>
			<?php if ($shipping_postcode) { echo $shipping_postcode . ' ';} 
			if ($shipping_address_4 == ''){
				echo $shipping_country . ', ' . $shipping_zone . ', г. ' . $shipping_city . ', ул. ' . $shipping_address_1 . ', дом ' . $shipping_address_2 . ' кв. ' . $shipping_address_3 . ' (' . $telephone . ') ';
				if ($fax <> "") { echo '<a href="' . $fax. '">страница получателя в Соц. сети</a>';}
			} else { 
				echo $shipping_country . ', ' . $shipping_zone . ', г. ' . $shipping_city . ', ул. ' . $shipping_address_1 . ', дом ' . $shipping_address_2 . ' корп ' . $shipping_address_4 . ' кв. ' . $shipping_address_3 . ' (' . $telephone . ') '; 
				if ($fax <> "") { echo '<a href="' . $fax. '">страница получателя в Соц. сети</a>';}
			} 
			?>
			</td>
		  ...
		  <tr>
            ...
            <td><input type="text" name="tracking_number" value="<?php echo $tracking_number; ?>" /><a id="button-tracking_number" class="button"><?php echo $button_tracking_number; ?></a><span id="tracking_comment"></span></td>
          </tr>
		  
		</table>
		</div>
		
		<div style="float:clear; margin-left: 49%; padding-left: 10px;border-left:solid 1px #777;">
        ...
        <table class="form">       
          <tr>
            ...
            <td><textarea name="comment_comment" cols="40" rows="8" style="width: 99%"></textarea>
              <div style="margin-top: 10px; text-align: right;"><a id="button-comment" class="button"><?php echo $button_add_comment; ?></a></div></td>
          </tr>
        </table>
		</div>
		</div>
		...
		<table class="list">
          <thead>
            <tr>
			  ...
			  <td class="left"><?php echo $column_articul; ?></td>
          ...
          <tbody>
            ...
            <tr>
			<td class="left"><?php if ($product['image'] != "") {?><a href="/index.php?route=product/product&path=&product_id=<?php echo $product['product_id']; ?>" target="_blank"><img src="<?php echo $product['image'];?>" style="padding: 1px; border: 1px solid #DDDDDD;"></a><?php } ?></td>
          ...
          <?php foreach ($totals as $totals_total) { ?>
          <tbody id="totals">
            <tr>
              <td colspan="6" class="right"><?php echo $totals_total['title']; ?>:</td>
              <td class="right"><?php echo $totals_total['text']; ?></td>
            </tr>
          </tbody>
          <?php } ?>
        </table>
		
		<hr><h2>История заказа</h2>
      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            ...
            <td><a href="<?php echo $affiliate; ?>"><?php echo $affiliate_lastname; ?> <?php echo $affiliate_firstname; ?> <?php echo $affiliate_middlename; ?></a></td>
          </tr>
          <tr>
      ...
      <div id="tab-payment" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            <td><?php echo $text_middlename; ?></td>
            <td><?php echo $payment_middlename; ?></td>
          </tr>
          ...
          <tr>
            <td><?php echo 'Адрес:'; ?></td>
             <td><?php echo "$shipping_address_1 $shipping_address_2 $shipping_address_3"; ?></td>
          </tr>  
      ...
      <div id="tab-shipping" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            <td><?php echo $text_middlename; ?></td>
            <td><?php echo $shipping_middlename; ?></td>
          </tr>
          <?php if ($shipping_company) { ?>
          <tr>
            <td><?php echo $text_company; ?></td>
...
$('#comments').load('index.php?route=sale/order/comments&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');


$('#button-comment').live('click', function() {
if ($('textarea[name=\'comment_comment\']').val().length >0 )
	$.ajax({
		url: 'index.php?route=sale/order/comments&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'html',
		...
		beforeSend: function() {
			...
			$('#comments').prepend('<div class="attention"><img src="view/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
...
$('#button-history').live('click', function() {
	$.ajax({
		...
		success: function(html) {
			...
			//if (encodeURIComponent($('select[name=\'order_status_id\']').val()) == 5) $('#reward-add').click(); else $('#reward-remove').click();
		}
	});
});

$('#button-tracking_number').live('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/trackingnumber&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		data: 'tracking_number=' + encodeURIComponent($('input[name=\'tracking_number\']').val()),
		beforeSend: function() {
			$('#button-tracking_number').after('<img src="view/image/loading.gif" class="loading" style="padding-left: 5px;" />');
		},
		complete: function() {
			$('.loading').remove();
		},
		success: function(json) {
			...
			if (json['success']) {
				...
				$('select[name=\'order_status_id\']').val(16).attr("selected", "selected");
				$('input[name=\'notify\']').prop( "checked", true );
				$('textarea[name=\'comment\']').val('Ваш трек-код для отслеживания местонахождения почтовой посылки: '+encodeURIComponent($('input[name=\'tracking_number\']').val())+'\n\nСайт для отслеживания: http://www.russianpost.ru/tracking20/');
