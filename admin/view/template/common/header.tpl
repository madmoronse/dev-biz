    ...
    <ul class="left" style="display: none;">
      ...
      <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
          ...
          <li><a href="/crontab/make_novelty_new.php" target="_blank">Импортировать новинки</a></li>
		  <li><a href="<?php echo $promo_settings; ?>"><?php echo $text_promo_settings; ?></a></li>
        </ul>
      </li>
        ...
        <ul>
          ...
          <li><a class="parent"><?php echo $text_customer; ?></a>
            <ul>
              ...
              <li><a href="<?php echo $teacher; ?>"><?php echo $text_teacher; ?></a></li>
        ...
        <ul>
          ...
          <li><a class="parent"><?php echo $text_design; ?></a>
            <ul>
			  ...
			  <li><a href="<?php echo $slim_banner; ?>"><?php echo $text_slim_banner; ?></a></li>
            </ul>
          </li>
		  ...
		  <li><a href="<?php echo $clear_cache; ?>"><?php echo $text_clear_cache; ?></a></li>
        </ul>
      </li>
      <li id="reports"><a class="top"><?php echo $text_reports; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $report_abandoned_carts; ?>"><?php echo $text_report_abandoned_carts; ?></a></li>
        </ul>
      </li>
      ...
      <li id="dashboard"><a href="/index.php?route=account/email_subscribers" class="top"><?php echo "Скачать адреса рассылок"; ?></a></li>
    </ul>
