...
<tr valign="top">
	...
	<td>
		<table class="list" style="width: 600px; float: left">
			...
			<tr>
				<td><?php echo $text_filterpro_discounts?></td>
				<td>
					<textarea type="text" name="filterpro_setting[filterpro_discounts]" rows="2"><?php echo $setting['filterpro_discounts']?></textarea>
				</td>
			</tr>
			<tr>
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><select name="filterpro_module[<?php echo $module_row; ?>][position]">
				...
				<?php if ($module['position'] == 'category_filter') { ?>
				<option value="category_filter" selected="selected">Под хлебными крошками</option>
				<?php } else { ?>
				<option value="category_filter">Под хлебными крошками</option>
				<?php } ?>
...
function addModule() {
	...
	html += '      <option value="category_filter">Под хлебными крошками</option>';
