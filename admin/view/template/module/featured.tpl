      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="block_name" value="<?php echo $block_name; ?>" style="width:400px;"/></td>
          </tr>
		  <tr>
          ...
          <tr>
            ...
            <td><div id="featured-product" class="scrollbox">
                ...
                <div id="featured-product<?php echo $product['product_id']; ?>" class="<?php echo $class; ?>"><?php echo $product['name']; ?> <?php echo ' (Артикул: ' . $product['product_id'] . ') '; ?><img src="view/image/delete.png" alt="" />
                  <input type="hidden" value="<?php echo $product['product_id']; ?>" />
                </div>
                <?php } ?>
              </div><br />
              <input type="text" style="width:95%"name="featured_product" value="<?php echo $featured_product; ?>" /></td>
          </tr>
        </table>
		...
		$.ajax({
			...
			success: function(json) {		
				response($.map(json, function(item) {
					return {
						label: item.name + ' (Артикул: ' + item.product_id + ')',
