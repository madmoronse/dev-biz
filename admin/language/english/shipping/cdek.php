...
$_['entry_use_region']					= 'Учитывать регион при определении города доставки за пределами России:<span class="help">Если название ригиона, области, штата, провинции и т.д. не совпадает с таковым в базе СДЭК, то доставка не будет расчитана. При выключенной опции точность определения снижается.</span>';
$_['entry_use_region_russia']			= 'Учитывать регион при определении города доставки по России:<span class="help">Если название ригиона, области, штата, провинции и т.д. не совпадает с таковым в базе СДЭК, то доставка не будет расчитана. При выключенной опции точность определения снижается.</span>';
